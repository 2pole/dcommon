...
namespace DCommon.Mvc.Grid
{
	...
	public class GridColumn<T> : IGridColumn<T> where T : class
	{
        ...
        private ListSortDirection? _initialDirection; 
        ...
        public ListSortDirection? InitialDirection
		{
        ...
        IGridColumn<T> IGridColumn<T>.SortInitialDirection(ListSortDirection initialDirection)
		{
