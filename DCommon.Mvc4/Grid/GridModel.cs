...
namespace DCommon.Mvc.Grid
{
	...
	public class GridModel<T>  : IGridModel<T> where T : class
	{
        ...
        private IDictionary<string, object> _bodyAttributes = new Dictionary<string, object>();
        ...
        IDictionary<string, object> IGridModel<T>.BodyAttributes
        {
            get { return _bodyAttributes; }
            set { _bodyAttributes = value; }
        }
        ...
        public void BodyAttributes(IDictionary<string, object> attributes)
        {
            _bodyAttributes = attributes;
        }
