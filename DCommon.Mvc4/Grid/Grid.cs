...
namespace DCommon.Mvc.Grid
{
	...
	public class Grid<T> : IGrid<T> where T : class
	{
	    ...
	    public IGridWithOptions<T> AllowPage(bool allowPage)
	    {
	        _gridModel.AllowPage = allowPage;
	        return this;
	    }
        ...
        public IGridWithOptions<T> BodyAttributes(IDictionary<string, object> attributes)
        {
            _gridModel.Attributes = attributes;
            return this;
        }
