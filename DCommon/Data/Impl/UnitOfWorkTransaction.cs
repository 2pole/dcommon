...
namespace DCommon.Data.Impl
{
    public class UnitOfWorkTransaction : ITransaction
    {
        ...
        {
            Check.Require(uowScope != null, "The unit of work scope was null");
            Check.Require(transactionScope != null, "The transaction scope was null");
