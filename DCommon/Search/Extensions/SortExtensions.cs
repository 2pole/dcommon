...
namespace DCommon.Search
{
    ...
    public static class SortExtensions
    {
        ...
        public static IEnumerable<T> OrderBy<T>(this IEnumerable<T> datasource, string propertyName, ListSortDirection direction)
        {
        ...
        /// <param name="propertyName">The name of the property to order by</param>
        /// <param name="direction">The direction</param>
        public static IQueryable<T> OrderBy<T>(this IQueryable<T> datasource, string propertyName, ListSortDirection direction)
        {
