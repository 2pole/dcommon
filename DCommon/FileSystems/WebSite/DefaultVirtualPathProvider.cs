...
namespace DCommon.FileSystems.WebSite
{
    public class DefaultVirtualPathProvider : IVirtualPathProvider
    {
        ...
        {
            Logger = LogManager.GetLogger(typeof (DefaultVirtualPathProvider));
        }
        ...
        public virtual string ToAppRelative(string virtualPath)
        {
            ...
            catch (Exception e)
            {
                ...
                Logger.InfoFormat("Path '{0}' cannot be made app relative", e, virtualPath);
                return null;
            }
        }
        ...
        public virtual bool TryFileExists(string virtualPath)
        {
            ...
            {
                Logger.InfoFormat("File '{0}' can not be checked for existence. Assuming doesn't exist.", e, virtualPath);
                return false;
            }
        }
