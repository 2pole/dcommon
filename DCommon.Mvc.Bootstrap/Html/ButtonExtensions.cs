...
namespace DCommon.Mvc.Bootstrap.Html
{
    ...
    public static class ButtonExtensions
    {
        ...
        public static MvcHtmlString Button(this HtmlHelper html, string text, ButtonType type, object htmlAttributes)
        {
            return Button(html, text, type, ButtonSize.Defualt, ButtonTag.Defualt, false, false, htmlAttributes);
        }
